...
function cargarProductos() {
  ...
  $.ajax({
    ...
    url: "http://168.138.126.1:8082/api/chocolate/all",
    type: "GET",
    dataType: "json",
...
function crearProducto(producto) {
  ...
  if (validarProducto(producto)) {
    $.ajax({
      ...
      url: "http://168.138.126.1:8082/api/chocolate/new",
      type: "POST",
      data: dataToSend,
      datatype: "JSON",
...
function eliminarProducto(reference){
    ...
    if(opc){
        $.ajax({
            ...
            url: "http://168.138.126.1:8082/api/chocolate/" + producto.reference,
            type: "DELETE",
            datatype: "JSON",
            contentType: "application/json",
            success: function (producto) {
...
function actualizarProducto(producto){
  ...
  $.ajax({
    ...
    url: "http://168.138.126.1:8082/api/chocolate/update",
    type: "PUT",
    data: dataToSend,
    datatype: "JSON",
    contentType: "application/json",
